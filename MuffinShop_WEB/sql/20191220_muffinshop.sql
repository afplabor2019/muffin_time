...
--
-- Gép: 127.0.0.1:3306
-- Létrehozás ideje: 2019. Dec 20. 06:37
...
(7, 'Somcsikli muffin', 'somcsiklisztikus', 6999, 'somcsiklimuffin.png'),
(8, 'VivinyÅ‘ muffin', 'Vivinyisztikus', 9998, 'vivinyå‘muffin.png');
...
(21, 3, '2019-12-17 07:14:39', 1, 1, 1893),
(20, 9, '2019-12-16 08:58:46', 1, 1, 798),
(19, 6, '2019-12-16 08:21:07', 1, 2, 299),
(18, 3, '2019-12-16 08:17:26', 1, 1, 299),
(22, 6, '2019-12-19 10:25:40', 1, 1, 69990);
...
(18, 4, 1, ''),
(19, 4, 1, 'nagyon cukik vagytok kÃ¶szi :3'),
(20, 3, 2, 'kÃ¶szi :3'),
(21, 4, 5, ''),
(21, 1, 2, ''),
(22, 7, 10, '');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('basic','admin') COLLATE utf8_hungarian_ci NOT NULL DEFAULT 'basic',
  PRIMARY KEY (`user_id`)
...
(3, 'teszt', 'teszt@teszt.hu', '$2y$10$XEgEUjn2gphuoKeQvsFLDOLhOuJ/dBn6cEw.L06W1oqhjqunrSGn.', 'basic'),
(6, 'admin', 'admin@admin.hu', '$2y$10$d/nK1wIY2OCazy0JBjoasOaI21Hv/nvzcAlHV76tJliqpgmRetmBy', 'admin'),
(7, 'Kate', 'vereczkikitti@gmail.com', '$2y$10$Le.ow0g24d2Sww6c3Q07Pu7VqrdoeXL4qalPFzR/pZNB2SngEzfSm', 'basic'),
(8, 'anyuci', 'vereczkimagdus@gmail.com', '$2y$10$XqcAx0gtHf9vUD/gCYT4EeAprOtWDd.bq2aNbq7gduzCYNv1pL9Oy', 'basic'),
(9, 'vereczkibalint', 'vereczkibalint@gmail.com', '$2y$10$j09ysCdsFvtbAzi5wsO9CuvqzyUlljTyO1bJhSI4CrNdXVB5xvqM2', 'basic');
...
(6, 2660, 'Balassagyarmat', 'Baltik Frigyes utca 15', '', '36709467592'),
(9, 2660, 'Balassagyarmat', 'Baltik Frigyes utca 15', '', '36709467592');
COMMIT;
